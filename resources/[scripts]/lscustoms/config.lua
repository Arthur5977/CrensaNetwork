vehicleCustomisationPrices = {
	cosmetics = 1250,
	respray = 1250,
	engines = { 999999, 20000, 40000, 60000, 80000, 125000 },
	brakes = { 999999, 15000, 30000, 45000, 60000, 100000 },
	transmission = { 999999, 20000, 40000, 60000, 80000, 125000 },
	suspension = { 999999, 25000, 50000, 75000, 100000, 125000 },
	shield = { 999999, 25000, 50000, 75000, 100000, 200000 },
	turbo = 7250,
	wheels = 1250,
	customwheels = 1250,
	wheelsmoke = 775,
