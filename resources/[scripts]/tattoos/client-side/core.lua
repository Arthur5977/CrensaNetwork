...
AddEventHandler("tattoos:Apply",function(Table)
	Tattoos = Table
...
-----------------------------------------------------------------------------------------------------------------------------------------
local Locations = {
    vec3{ 1322.93, -1652.29, 52.27 },
    vec3{ -1154.42, -1425.9, 4.95 },
    vec3{ 322.84, 180.16, 103.58 },
    vec3{ -3169.62, 1075.8, 20.83 },
    vec3{ 1864.07, 3747.9, 33.03 },
    vec3{ -293.57, 6199.85, 31.48 }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADSTART
-----------------------------------------------------------------------------------------------------------------------------------------
...
RegisterNUICallback("Change",function(Data,Callback)
	...
	if Active[Types] and Active[Types]["tattoo"] and Active[Types]["tattoo"][Number] then
		...
		if Tattoos[Name] then
			...
			Tattoos[Name] = Active[Types]["tattoo"][Number]["part"]
		end
