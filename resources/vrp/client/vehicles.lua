...
function tvRP.ClosestVehicle(Radius)
	...
	if IsAnyVehicleNearPoint(Coords,Radius) then
		Vehicle = GetClosestVehicle(Coords,Radius,0,231807)
		if Vehicle == 0 then
			Vehicle = GetClosestVehicle(Coords,Radius,0,391551)
		end
	end
...
function tvRP.VehicleName()
    if IsPedInAnyVehicle(PlayerPedId()) then
        return List[GetEntityModel(GetVehiclePedIsUsing(PlayerPedId()))]
    end
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- VEHICLEMODEL
